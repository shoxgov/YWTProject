...
import com.sq.ywt.R;
import com.sq.ywt.YWTApplication;
import com.sq.ywt.activity.HomeFragmentActivity;
...
public class BannerView extends RelativeLayout {
	...
	public BannerView(Context context, AttributeSet attrs) {
		...
		imageLoader = YWTApplication.getInstance().getImageLoader();
		init();
	}
	...
	private void init() {
        ...
        vParams.height = HomeFragmentActivity.screenWidthPixels * 430 / 1903;
