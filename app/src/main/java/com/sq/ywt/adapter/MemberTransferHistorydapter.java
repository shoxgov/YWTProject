 ...
 * @version: V1.0
 */
public class MemberTransferHistorydapter extends BaseAdapter {
    private Context mContext;
    private List<NoticItemInfo> mList;

    public MemberTransferHistorydapter(Context mContext) {
        super();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(this.mContext).inflate(
                    R.layout.membertransferhistory_item, null);
