 ...
 */
public class BonusDetailActivity extends Activity implements View.OnClickListener {
    private TextView startdate;
    private TextView enddate;
    private ListView bonusdetailList;
    private bonusdetaildapter adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        requestWindowFeature(Window.FEATURE_NO_TITLE);
        setContentView(R.layout.activity_bonusdetail);
        initView();
        init();
    }

    private void init() {
        adapter = new bonusdetaildapter(this);
        bonusdetailList.setAdapter(adapter);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.startdate:
                ...
                new DatePickerDialog(BonusDetailActivity.this,
                        // 绑定监听器
